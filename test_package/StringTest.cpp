...
#include "../src/xuexue/csharp/String.h"
...
{
    wstring ws = L"en中文和❀❀❀❀!";
    string s = String::ToUTF8(ws);
    wstring ws2 = String::UTF8ToWStr(s);
    ASSERT_TRUE(ws == ws2);
}
...
TEST(String, GBKToUTF8)
{
    ...
    string utf8 = String::ToUTF8(ws);
    wstring ws2 = String::UTF8ToWStr(utf8);
    ASSERT_TRUE(ws == ws2);

    string gbk = String::UTF8ToGBK(utf8);
    string utf8_2 = String::GBKToUTF8(gbk);
    ASSERT_TRUE(utf8 == utf8_2);
    ws2 = String::UTF8ToWStr(utf8_2);
    ASSERT_TRUE(ws == ws2);
}