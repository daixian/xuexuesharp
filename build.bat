...
conan create . daixian/stable -s compiler.runtime=MD -s arch=x86 -s build_type=Release --build missing
conan create . daixian/stable -s compiler.runtime=MT -s arch=x86_64 -s build_type=Release --build missing
conan create . daixian/stable -s compiler.runtime=MT -s arch=x86 -s build_type=Release --build missing